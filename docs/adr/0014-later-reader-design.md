...
> **Superseded by [ADR 0018](0018-two-bar-icon.md).** The split recorded here —
> one mark inline, another for the icons — is reversed: the two bars are now the
> mark everywhere, and the monogram is gone. The rest of this ADR stands.
